module VoilkRuby
  module Mixins
    module ActsAsPoster
      ...
      # @option options [String] :max_accepted_payout (1000000.000 VSD) Maximum accepted payout, set to '0.000 VSD' to deline payout
      # @option options [Integer] :percent_voilk_dollars (5000) Percent VOILK Dollars is used to set 50/50 or 100% VOILK Power
      ...
      def post(options = {})
        ...
        percent_voilk_dollars = options[:percent_voilk_dollars]
        ...
        if (!!max_accepted_payout &&
          ...
          ) || !!percent_voilk_dollars || !allow_votes || !allow_curation_rewards
          @operations << {
            type: :comment_options,
            author: account_name,
            permlink: permlink,
            max_accepted_payout: max_accepted_payout,
            percent_voilk_dollars: percent_voilk_dollars,
