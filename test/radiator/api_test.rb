...
module Radiator
  class ApiTest < Radiator::Test
    ...
    def test_get_accounts
      vcr_cassette('get_accounts') do
        @api.get_accounts(['inertia']) do |accounts|
          ...
          assert_equal 'SHR5LC8uBiiaihoPhM16CKktPnfb1Yop7fLicuNVgZm6JvU8yCZ7v', owner_key_auths.first
        end
      end
    end
    ...
    def test_get_coining_delegations
      vcr_cassette('get_coining_delegations') do
        @api.get_coining_delegations('minnowbooster', -1000, 1000) do |delegation|
