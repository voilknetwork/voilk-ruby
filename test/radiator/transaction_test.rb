...
module Radiator
  class TransactionTest < Radiator::Test
    ...
    def test_valid_chains
      %w(bears test).each do |chain|
        ...
        when :bears
          ...
          assert_equal Radiator::Transaction::NETWORKS_BEARS_CHAIN_ID, transaction.chain_id, 'expect bears chain'
        when :test
    ...
    def test_to_bytes
      ...
      assert_equal 'b510834141c312c2aa8837040734605f2333f1ecc4f634576372f9c12dc7e8b2',
