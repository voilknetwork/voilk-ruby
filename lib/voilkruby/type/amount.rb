module VoilkRuby
  module Type
    ...
    # See: https://github.com/xeroc/piston-lib/blob/34a7525cee119ec9b24a99577ede2d54466fca0e/voilkbase/operations.py
    class Amount < Serializer
      def initialize(value)
        ...
        when ::Array
          a, p, t = value
          @asset = case t
          when '@@000000013' then 'VSD'
          when '@@000000021' then 'VOILK'
      ...
      def to_a
        case @asset
        when 'VOILK' then [(@amount.to_f * 1000).to_i.to_s, 3, '@@000000021']
        when 'COINS' then [(@amount.to_f * 1000000).to_i.to_s, 6, '@@000000037']
        when 'VSD' then [(@amount.to_f * 1000).to_i.to_s, 3, '@@000000013']
        else; raise TypeError, "Asset #{@asset} unknown."
        end
      end
