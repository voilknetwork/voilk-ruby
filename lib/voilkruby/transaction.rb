...
module VoilkRuby
  ...
  private
      ...
      while @expiration.nil? && @ref_block_num.nil? && @ref_block_prefix.nil?
        ...
        @api.get_block(block_number) do |block, error|
          ...
          if !!block && !!block.previous
            ...
            # https://github.com/voilknetwork/voilk/blob/57451b80d2cf480dcce9b399e48e56aa7af1d818/libraries/chain/database.cpp#L2870
            # https://github.com/voilknetwork/voilk/issues/1215
    ...
    # See: https://github.com/voilknetwork/voilk/issues/1944
    def canonical?(sig)
      sig = sig.unpack('C*')
