module VoilkRuby
  # VoilkRuby::Stream allows a live view of the VOILK blockchain.
  # 
  ...
  class Stream < Api
    ...
    #       puts "#{vop.author} got paid for #{vop.permlink}: #{[vop.vsd_payout, vop.voilk_payout, vop.coining_payout]}"
    #   end
    #
  ...
  private
    ...
    def virtual_op_type?(type)
      ...
      (VoilkRuby::OperationTypes::TYPES.keys && type).any?
    end
